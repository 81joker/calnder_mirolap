    ...
    <div class="container-fluid ">
        <div class="row main">
            ...
            <div class="col-md-6  calander">
                ...
                <div class="fetch">
                    <div class="speichen">
                        <form method="post" id="#my-form" action="crud_action.php">
                            <div class="form-row">
                    ...
                    <tbody>
                        <?php while ($kalnder = $kalnders->fetch_assoc()) : ?>
                            <tr>
                                ...
                                <td><a href="#" class="btn btn-default shadow-none" onclick="edit_kalnder(<?= $kalnder['id'] ?>)">bearbeiten</a>
                                    <!-- <td><a href="#" class="btn btn-default shadow-none" ">bearbeiten</a> -->
...
<script>
    ...
    //Function Update Kalnder
    function edit_kalnder(id) {
        var data = {
            "id": id
        };
